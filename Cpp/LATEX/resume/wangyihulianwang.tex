...
\newcommand{\job}{\hspace*{-10cm}视觉算法工程师\\[-.3cm] {\hspace*{.6cm}\zihao{-4}深度学习方向}}% 网易互联网 
...
\begin{tikzpicture}[remember picture,overlay]
	...
	\node[textNodeStyle,anchor=west,text width=5cm,align=left] (job) at ([shift={(.65, \joby)}]current page.north west) {\MyJob{\job}};
