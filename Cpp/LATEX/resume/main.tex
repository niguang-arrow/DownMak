...
%\newcommand{\job}{算法工程师} %京东
%\newcommand{\job}{算法工程师-图像图形} % 阿里菜鸟网络
%\newcommand{\job}{算法工程师-计算机视觉} % 腾讯
\newcommand{\job}{算法研发工程师} % 华为 云计算与大数据 IT
...
\begin{itemize}
	...
	\item 深度学习框架：了解常用深度学习框架，对 \textbf{PyTorch}，\textbf{Caffe} 以及 TinyDnn 等框架有一定的研究，掌握网络构建、\textbf{反向传播机制}、常用\textbf{优化算法}，熟悉深度学习常用的网络结构，如 \textbf{ResNet}，\textbf{VGG}等；%熟悉目标检测框架 \textbf{Faster-RCNN}
