...
\tkernelPos{convDark}{add}{below}{index}{(0, -1.5*\dis)}{Add};
\tkernelPos{convBlue}{thre}{below}{add}{(-1, -3*\dis)}{Thresh};
\tkernelPos{convPurple}{linear1}{below}{add}{(1.8, -1.5*\dis)}{Linear1};
...
\draw[arrStyle] (index) -- ++(0, 2.5*\dis) node[midway, anodeStyle] (out) {};
...
\tNodePos{prevgrad}{right}{thre}{(.48, 0)}{\color{red}prev\_grad};
\tNodePos{gradinput}{above}{linear1}{(-.58, .1)}{\color{red}grad\_input};
\end{tikzpicture}
